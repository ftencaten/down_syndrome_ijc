...
#write_tsv(ds.degs, 
#          'results/rnaseq/degs_DS_vs-nonDS_56patients.tsv')
...
write_tsv(gsea.result@result,
          'results/rnaseq/gsea_pathway_enrichment_DS_vs-nonDS_Hallmark_BTM_56patients.tsv')
...
### NbClust 
opt.n.cluster <- NbClust(m.mat, min.nc = 2, max.nc = 10, 
                         method = 'kmeans', 
                         index = 'sdbw', alphaBeale = 0.1)
